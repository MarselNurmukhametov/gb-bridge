# Статус · 2026-08-06 05:11 UTC

Состояние на 06.08.2026 · ветка `main`, коммит `72e3a84` · тестов зелёных: **910** · прод (/api/health): `72e3a84`

## Сквозные пути

```
  зелёный · сайт → лавка → чат → заявка
  зелёный · правка по секретной ссылке переживает пересборку
  зелёный · добор пробела закрывает слот словами владельца
  зелёный · с нуля: разговор → лавка → ссылка на правку
Все 4 путей зелёные.
```
