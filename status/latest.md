# Статус · 2026-08-06 11:05 UTC

Состояние на 06.08.2026 · ветка `main`, коммит `660ef52` · тестов зелёных: **954** · прод (/api/health): `660ef52`

## Сквозные пути

```
  зелёный · сайт → карточка → чат → заявка
